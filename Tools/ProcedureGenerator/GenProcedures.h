...
namespace SP
{
    ...
    public:
    	...
    	void In_CreateData(TIMESTAMP_STRUCT& v) { BindParam(2, v); };
    	void In_CreateData(TIMESTAMP_STRUCT&& v) { _createData = std::move(v); BindParam(2, _createData); };

    private:
    	int32 _gold = {};
    	TIMESTAMP_STRUCT _createData = {};
    };
